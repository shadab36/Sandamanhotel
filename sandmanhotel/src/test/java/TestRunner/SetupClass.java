...
public class SetupClass {
	...
	public static String local_Fifefox_browser;
	...
	public static void before_Class() throws Exception {
		...
		browserName = property.getProperty("browser2");
		...
		if ((localtest.equals("yes")) && oncloud.equals("no")) {
			...
			System.out.println(baseURL);
				...
				/*** To run desktop project on local */
				lbrowser = System.setProperty(CommonData.Firefox_Name, CommonData.Firefox_Path);
				lbrowser = System.getProperty("local_Fifefox_browser");
